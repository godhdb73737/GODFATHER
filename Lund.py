...
async def Krypton_stats():
    while True:
        ...
        sv_ch = client.get_channel(1069637555240316990)
        users_ch = client.get_channel(1069637603286056970)
...
@tree.command(name="embed", description="Create A Embed Using Apex")
...
async def on_command_completion(context: Context) -> None:
    ...
    hacker = client.get_channel(1069671276563673210)
    if context.guild is not None:
        try:
            ...
            embed.add_field(
                ...
                inline=False)
            embed.set_footer(text="Powered By Apex",
        ...
        try:
            ...
            embed1.add_field(
                ...
                f"{context.author} | ID: [{context.author.id}](https://discord.com/users/{context.author.id})",
                inline=False)
            embed1.set_footer(text="Powered By Apex",
                              icon_url=client.user.display_avatar.url)
